  ...
  return (
    <form className="w-full max-w-xl m-2 px-4 sm:p-0">   
      ...
      <div className="relative">
        ...
        <input required onChange={handleChange} value={value} type="search" id="default-search" className="block w-full p-4 pl-10 text-xl text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Cities..."/>
